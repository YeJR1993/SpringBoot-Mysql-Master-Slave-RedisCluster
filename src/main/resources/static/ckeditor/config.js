...
CKEDITOR.editorConfig = function(config) {
	...
	config.filebrowserBrowseUrl = '/upload/ckEditorUploadImg';
	config.filebrowserImageBrowseUrl = '/upload/ckEditorUploadImg';
	config.filebrowserFlashBrowseUrl = '/upload/ckEditorUploadImg';
	config.filebrowserUploadUrl = '/upload/ckEditorUploadImg';
	
	config.filebrowserImageUploadUrl = '/upload/ckEditorUploadImg';
	config.filebrowserFlashUploadUrl = '/upload/ckEditorUploadImg';
