...
<html lang="zh">
	...
	<body>
							...
							<form class="form-horizontal" id="loginForm" method="POST" action="/authorize">
								...
								<div class="form-group">
									...
									<a href="javascript:void(0);" title="点击更换验证码">
							            <img id="imgVerify" src="" alt="更换验证码"  onclick="getVerify()">
							        </a>
								</div>
								<div class="form-group">
		...
		<input id="message" type="hidden" value="${msg!''}" hidden="hidden">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				if(self.frameElement && self.frameElement.tagName == "IFRAME"){
					top.layer.msg("请重新登录！", {icon : 2,offset : '40%',time : 2000}, function() {
						top.location = "/";
					});
				};
				// 获取一次验证码 
