											...
											<td>
												<div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
	                                                    ...
	                                                    <@shiro.hasPermission name="shop:add:shopInfo">
															<button type="button" class="am-btn am-btn-default am-btn-xs am-text-thirdly" onclick="openDialogSave('添加商店', '/shop/info/form?userId=${user.id}&urlType=0','960px', '720px')"><span class="am-icon-plus"></span> 开店</button>
														</@shiro.hasPermission>
	                                                    <@shiro.hasPermission name="sys:delete:user">
