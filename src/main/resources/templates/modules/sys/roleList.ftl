												...
												<div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
	                                                    <@shiro.hasPermission name="sys:view:role">
	                                                    	<button class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="openDialogView('查看角色', '/sys/role/form?id=${role.id}','480px', '330px')"><span class="am-icon-copy"></span> 查看</button>
	                                                    </@shiro.hasPermission>
	                                                    <@shiro.hasPermission name="sys:edit:role">
															<button class="am-btn am-btn-default am-btn-xs am-text-secondary"  onclick="openDialogSave('编辑角色', '/sys/role/form?id=${role.id}','480px', '330px')"><span class="am-icon-pencil-square-o"></span> 编辑</button>
	                                                    </@shiro.hasPermission>
	                                                    <@shiro.hasPermission name="sys:allocation:role">
															<button class="am-btn am-btn-default am-btn-xs am-text-thirdly"  onclick="openDialogSave('权限设置', '/sys/role/auth?id=${role.id}','260px', '540px')"><span class="am-icon-pencil-square-o"></span> 权限设置</button>
	                                                    </@shiro.hasPermission>
	                                                    <@shiro.hasPermission name="sys:delete:role">
