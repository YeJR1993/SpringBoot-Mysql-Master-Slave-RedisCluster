...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken)
		...
		String validateCodeGenerate = JedisUtils.getStr(SystemModule.validateCode, session.getId().toString());
		...
		// 验证完之后删除该验证码
		JedisUtils.deleteStr(SystemModule.validateCode, session.getId().toString());
