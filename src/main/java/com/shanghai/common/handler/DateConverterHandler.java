...
public class DateConverterHandler implements Converter<String, Date> {
	...
	static {
		FORMARTS.add(TimeConstants.YYYY_MM);
		FORMARTS.add(TimeConstants.YYYY_MM_DD);
		FORMARTS.add(TimeConstants.YYYY_MM_DD_HH_MM);
		FORMARTS.add(TimeConstants.YYYY_MM_DD_HH_MM_SS);
	}
