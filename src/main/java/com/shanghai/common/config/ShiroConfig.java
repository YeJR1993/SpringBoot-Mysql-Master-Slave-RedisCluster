...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put(filterChain+"/**", "anon");
	...
	public SessionDAO redisSessionDao() {
		// 使用构造的方式
		ShiroRedisSession session = new ShiroRedisSession(sessionExpireTime);
		// 指定sessionid生成器
		session.setSessionIdGenerator(new JavaUuidSessionIdGenerator());
		return session;
	}
	...
	public ShiroRedisCacheManager shiroRedisCacheManager() {
		return new ShiroRedisCacheManager(cacheExpireTime);
	}
