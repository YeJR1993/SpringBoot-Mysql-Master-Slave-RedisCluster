...
public class UploadController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "openWebUploadPage")
	...
	public JSONObject ckEditorUpLoadImage(@RequestParam("upload")MultipartFile file) throws IllegalStateException, IOException {
		...
		jsonObject.put("url", dest.getPath());
		return jsonObject;
	}
}
